...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Quản Lý Sản Phẩm'); ?> — ShopAdmin</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('products.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('products.index') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">© <?php echo e(date('Y')); ?> ShopAdmin v1.0</div>
</aside>
...
<div class="main-wrapper">
    ...
    <header class="header">
        <div>
            <div class="header-title"><?php echo $__env->yieldContent('header-title', 'Dashboard'); ?></div>
            <div class="header-breadcrumb">
                🏠 <span>ShopAdmin</span> › <span><?php echo $__env->yieldContent('breadcrumb', 'Tổng quan'); ?></span>
            </div>
        </div>
        <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; font-size: .9rem;"><?php echo e(Auth::user()->name); ?></span>
            </div>
...
<?php /**PATH A:\xampp\htdocs\bookstore-mvc\resources\views/layouts/master.blade.php ENDPATH**/ ?>