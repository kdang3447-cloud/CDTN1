                                ...
                                <div class="product-thumb">
                                    <div class="image zoom">
                                        <a href="{{ route('product-detail', $product->BookID) }}">
                                            <img src="{{ image_url($product->Avatar) }}" alt="01" />
                                            <img src="{{ image_url($product->Avatar) }}" alt="02"
                                                class="second_image img-responsive" /> </a>
                                    </div>
                                    <div class="thumb-description">
                                        <div class="caption">
                                            <h4 class="product-title text-capitalize"><a
                                                    href="{{ route('product-detail', $product->BookID) }}">{{$product->BookTitle}}</a>
                                            </h4>
                                        </div>
                                        <div class="rating">
                                            ...
                                            <div class="price">
                                                <div class="regular-price">
                                                    {{ format_price_vnd($product->SellingPrice) }}</div>
                                                <div class="old-price">{{ format_price_vnd($product->CostPrice) }}</div>
                                            </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="price">
                                                        <div class="regular-price">
                                                            {{ format_price_vnd($product->SellingPrice) }}</div>
                                                        <div class="old-price">
                                                            {{ format_price_vnd($product->CostPrice) }}</div>
                                                    </div>
                                                </div>
                                                <div
                            ...
                            <div class="sidebar-filter left-sidebar w-100 float-left">
                                <div class="title">
                                    <a data-toggle="collapse" href="#sidebar-main" aria-expanded="false"
                                        aria-controls="sidebar-main" class="d-lg-none block-toggler">Product
                                        Categories</a>
                                </div>
                                <div id="sidebar-main" class="sidebar-main collapse">
                                    <div class="sidebar-block categories">
                                        <h3 class="widget-title"><a data-toggle="collapse" href="#categoriesMenu"
                                                role="button" aria-expanded="true" aria-controls="categoriesMenu">Nhóm
                                                sản
                                                phẩm</a></h3>
                                        ...
                                        <div id="categoriesMenu" class="expand-lg collapse show">
                                            <div class="nav nav-pills flex-column mt-4"> <a href="#"
                                                    class="nav-link d-flex justify-content-between mb-2 "><span>{{ $category['name'] }}</span><span
                                                        class="sidebar-badge"></span></a>
                                                @foreach ($category['genres'] as $genre)
                                                <div class="nav nav-pills flex-column ml-3">
                                                    <a href="{{ route('proByCate', $genre->GenreID) }}"
                                                        class="nav-link mb-2">{{ $genre->GenreName }}</a>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div id="size" class="sidebar-widget-option-wrapper collapse show">
                                            <div class="size-inner">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="group-1"
                                                        id="price-1">
                                    ...
                                    <div class="sidebar-block size">
                                        ...
                                        <div id="size" class="sidebar-widget-option-wrapper collapse show">
                                            <div class="size-inner">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="group-2"
                                                        id="{{$author->Author}}">
                                                    <label class="form-check-label"
                                                        for="item1">{{ $author->Author }}</label>
                                                </div>
                                                @endforeach
                                    ...
                                    <div class="sidebar-block size">
                                        ...
                                        <div id="size" class="sidebar-widget-option-wrapper collapse show">
                                            <div class="size-inner">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="group-3"
                                                        id="{{$publisher->PublisherID}}">
                                                    <label class="form-check-label"
                                                        for="item1">{{ $publisher->PublisherName }}</label>
                                                </div>
                                                @endforeach
                            ...
                            <div class="sidebar-product left-sidebar w-100 float-left">
                                <div class="title">
                                    <a data-toggle="collapse" href="#sidebar-product" aria-expanded="false"
                                        aria-controls="sidebar-product" class="d-lg-none block-toggler">sale
                                        products</a>
                                </div>
