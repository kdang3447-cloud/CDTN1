...
<script>
    ...
    const events = {
        ...
        showModalProductDetail(product) {
            ...
            document.querySelector("[data-product-selling-price]").textContent = formatPriceVND(product.SellingPrice);
            document.querySelector("[data-product-cost-price]").textContent = formatPriceVND(product.CostPrice);
    ...
    $(document).ready(function () {
        $('.btn-cart').on('click', function () {
            ...
            $('#cart-pop .regular-price').text(formatPriceVND(bookPrice));
            $('#cart-pop .old-price').text(formatPriceVND(bookOldPrice));
        });
    });
                                ...
                                <div class="product-thumb row">
                                    ...
                                    <div class="thumb-description col-xs-12 col-sm-9 col-md-10 position-static text-left">
                                        ...
                                        <div
                                            ...
                                            <div class="price">
                                                <div class="regular-price">${formatPriceVND(product.SellingPrice)}</div>
                                                <div class="old-price">${formatPriceVND(product.CostPrice)}</div>
                                            </div>
                                        </div>
                                        <div
