                ...
                <div class="product-large-image tab-content">
                    <div class="tab-pane active" id="product-01" role="tabpanel" aria-labelledby="product-tab-01">
                        <div class="single-img img-full">
                            <a href="{{ image_url($book->Avatar) }}">
                                <img src="{{ image_url($book->Avatar) }}" class="img-fluid zoomImg" alt="">
                            </a>
                        </div>
                    </div>
                    @php
                    ...
                    <div class="tab-pane" id="product-0{{ $i }}" role="tabpanel"
                        ...
                        <div class="single-img img-full">
                            <a href="{{ image_url($image->ImagePath) }}"><img src="{{ image_url($image->ImagePath) }}"
                    ...
                    <div class="nav-add small-image-slider-single-product-tabstyle-3 owl-carousel" role="tablist">
                        <div class="single-small-image img-full">
                            <a data-toggle="tab" id="product-tab-01" href="#product-01" class="img active"><img
                                    src="{{ image_url($book->Avatar) }}" class="img-fluid" alt=""></a>
                        </div>
                        @php
                        $i = 2;
                        @endphp
                        @foreach($images as $image)
                        <div class="single-small-image img-full">
                            <a data-toggle="tab" id="product-tab-0{{$i}}" href="#product-0{{ $i++ }}" class="img"><img
                                    src="{{ image_url($image->ImagePath) }}" class="img-fluid" alt=""></a>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="product-information">
                    ...
                    <div class="rating">
                        <div class="product-ratings d-inline-block align-middle">
                            ...
                            for($i = 0; $i < $star; $i++){ $starRatingHTML
                                .="<span class='fa fa-stac'><i class='material-icons'>star</i></span>" ; } for(
                                $i=$star; $i < 5; $i++){ $starRatingHTML
                                .="<span class='fa fa-stac'><i class='material-icons off'>star</i></span>" ; } echo
                                $starRatingHTML; @endphp </div>
                                <a href="#" class="review-down">(đánh giá)</a>

                        </div>
                        <div class="price float-left w-100 d-flex">
                            <div class="regular-price">{{ format_price_vnd($book->SellingPrice) }}</div>
                            <div class="old-price">{{ format_price_vnd($book->CostPrice) }}</div>
                        </div>
                            ...
                            <div class="rating float-left w-100">
                                <div class="product-ratings d-inline-block align-middle">
                                    ...
                                    for($i = 0; $i < $star; $i++){ $starRatingHTML
                                        .="<span class='fa fa-stac'><i class='material-icons'>star</i></span>" ; } for(
                                        $i=$star; $i < 5; $i++){ $starRatingHTML
                                        .="<span class='fa fa-stac'><i class='material-icons off'>star</i></span>" ; }
                                        echo $starRatingHTML; @endphp </div>
                                </div>
                                <div class="review-title float-left w-100"><span class="date">
                                        {{$review->CreatedDate}}</span></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="product-accessories-content products grid owl-carousel">
                            ...
                            <div class="product-thumb">
                                <div class="image zoom">
                                    <a href="{{ route('product-detail', $bookAu->BookID) }}">
                                        <img src="{{ image_url($bookAu->Avatar) }}" alt="01" />
                                        <img src="{{ image_url($bookAu->Avatar) }}" alt="02"
                                ...
                                <div class="thumb-description">
                                    ...
                                    <div class="rating">
                                        <div class="product-ratings d-inline-block align-middle">
                                            ...
                                            for($i = 0; $i < $star; $i++){ $starRatingHTML
                                                .="<span class='fa fa-stac'><i class='material-icons'>star</i></span>" ;
                                                } for( $i=$star; $i < 5; $i++){ $starRatingHTML
                                                .="<span class='fa fa-stac'><i class='material-icons off'>star</i></span>"
                                                ; } echo $starRatingHTML; @endphp </div>
                                        </div>
                                        <div class="price">
                                            <div class="regular-price">{{ format_price_vnd($bookAu->SellingPrice) }}
                                            </div>
                                            <div class="old-price">{{ format_price_vnd($bookAu->CostPrice) }}</div>
                                        </div>
                        ...
                        @else
                        <div class="position-relative" style="left: 50%;transform: translateX(-50%);">Không có cuốn sách
                            nào
                ...
                deleteButtons.forEach(function(button) {
                    button.addEventListener('click', function() {
                        if (confirm("Bạn có chắc là muốn xoá đánh giá này không ?")) {
                            var reviewID = this.getAttribute(
                                'data-review-id'); // Using plain JavaScript to get data attribute
                            ...
                            fetch('/api/delete-review/' + reviewID, {
                                ...
                                .then(function(response) {
                                    if (response.status === 200) {
                                        ...
                                        let totalRVCount = document.querySelector(
                                            "#totalReviewCount");
                                        totalRVCount.innerHTML = parseInt(totalRVCount.innerHTML) -
                                            1;
