                ...
                <div class="order-line float-left w-100" style="margin-bottom: 3px">
                    <div class="row">
                      ...
                      <div class="col-sm-6 col-xs-12 qty float-left d-flex">
                        <div class="col-xs-5 col-sm-5 text-sm-right text-xs-left">{{ format_price_vnd($item->book->CostPrice) }}</div>
                        <div class="col-xs-2 col-sm-2">{{ $item->Quantity }}</div>
                        <div class="col-xs-5 col-sm-5 text-sm-right bold">{{ format_price_vnd($item->book->CostPrice * $item->Quantity) }}</div>
                      </div>
                    </div>
                </div>
              @endforeach
