                        ...
                        <table class="table product-table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-p-price"><p>{{ format_price_vnd($item->book?->CostPrice) }}</p></td>
                                    <td class="table-p-qty"><input value="{{ $item->Quantity }}" name="cart-qty[{{ $item->CartItemID }}]" value="{{ $item->Quantity }}" type="number"></td>
                                    <td class="table-total"><p>{{ format_price_vnd($item->book?->CostPrice * $item->Quantity) }}</p></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="table-total-content">
                    ...
                    <div class="table-total-amount">
                        <div class="single-total-content d-flex justify-content-between float-left w-100">
                            <strong>Giá sản phẩm</strong><span>{{ format_price_vnd($bookPrice) }}</span>
                        </div>
                        <div class="single-total-content d-flex justify-content-between float-left w-100">
                            <strong>Chi phí vận chuyển</strong>
                            <span class="c-total-price">{{ format_price_vnd($shipPrice) }}</span>
                        </div>
                        ...
                        <div class="single-total-content tt-total d-flex justify-content-between float-left w-100">
                            ...
                            <span class="c-total-price" id="totalPrice">{{ format_price_vnd($totalPrice) }}</span>
                        </div>
